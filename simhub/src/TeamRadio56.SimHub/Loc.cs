...
namespace TeamRadio56.SimHub
{
    ...
    public static class Loc
    {
        ...
        private static readonly Dictionary<string, string> Ko = new Dictionary<string, string>
        {
            ...
            { "row_voice", "보이스" },
            { "hint_voice", "멘트 언어와 안 맞으면 엔진이 자동 보정합니다" },
            { "row_rate", "말 속도" },
            { "row_volume", "볼륨" },
            { "row_radiofx", "무전기 효과" },
            ...
            { "hint_race_only", "연습/퀄리는 고스트 차가 많음" },
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            { "row_mode", "Mode" },
            { "hint_mode", "then press [Restart engine]" },
            { "row_exe", "Executable" },
            ...
            { "hint_race_only", "practice/quali have many ghost cars" },
