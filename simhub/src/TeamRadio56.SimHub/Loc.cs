...
namespace TeamRadio56.SimHub
{
    ...
    public static class Loc
    {
        ...
        private static readonly Dictionary<string, string> Ko = new Dictionary<string, string>
        {
            ...
            { "choice_chatty", "chatty — 수다 (자주 불러줌)" },
            { "choice_lang_en", "en — 영어 무전 (권장)" },
            { "choice_lang_ko", "ko — 한국어 무전" },
            { "voice_en-GB-RyanNeural", "Ryan — 영국 남성, 레이스 엔지니어 톤 (기본)" },
            { "voice_en-GB-ThomasNeural", "Thomas — 영국 남성, 차분함" },
            { "voice_en-GB-SoniaNeural", "Sonia — 영국 여성" },
            { "voice_en-US-GuyNeural", "Guy — 미국 남성" },
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            { "choice_chatty", "chatty — talkative" },
            { "choice_lang_en", "en — English radio (recommended)" },
            { "choice_lang_ko", "ko — Korean radio" },
            { "voice_en-GB-RyanNeural", "Ryan — British male, race engineer tone (default)" },
            { "voice_en-GB-ThomasNeural", "Thomas — British male, calm" },
            { "voice_en-GB-SoniaNeural", "Sonia — British female" },
            { "voice_en-US-GuyNeural", "Guy — American male" },
